...
set(configMINIMAL_STACK_SIZE "70" CACHE STRING "")
...
option(configAPPLICATION_ALLOCATED_HEAP "" ON)
...
option(configAPPLICATION_ALLOCATED_HEAP_SIZE "" ON)
if (configAPPLICATION_ALLOCATED_HEAP_SIZE)
	set(configAPPLICATION_ALLOCATED_HEAP_SIZE_Value "1" CACHE INTERNAL "")
else (configAPPLICATION_ALLOCATED_HEAP_SIZE)
	set(configAPPLICATION_ALLOCATED_HEAP_SIZE_Value "0" CACHE INTERNAL "")
endif(configAPPLICATION_ALLOCATED_HEAP_SIZE)

option(configAPPLICATION_DEFINED_TICK_RATE "" ON)
if (configAPPLICATION_DEFINED_TICK_RATE)
	set(configAPPLICATION_DEFINED_TICK_RATE_Value "1" CACHE INTERNAL "")
else (configAPPLICATION_DEFINED_TICK_RATE)
	set(configAPPLICATION_DEFINED_TICK_RATE_Value "0" CACHE INTERNAL "")
endif(configAPPLICATION_DEFINED_TICK_RATE)
...
option(INCLUDE_uxTaskPriorityGet "" ON)
...
option(INCLUDE_vTaskSuspend "" OFF)
...
option(INCLUDE_vTaskDelayUntil "" ON)
...
option(INCLUDE_xTaskGetSchedulerState "" ON)
...
option(INCLUDE_xTaskGetCurrentTaskHandle "" ON)
...
option(INCLUDE_xTaskGetIdleTaskHandle "" ON)
...
option(INCLUDE_eTaskGetState "" ON)
...
option(INCLUDE_xTaskGetHandle "" ON)
...
option(INCLUDE_xTaskResumeFromISR "" ON)
